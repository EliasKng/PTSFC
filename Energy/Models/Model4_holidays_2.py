...
from Energy.HelpFunctions.dummy_mapping import get_winter_dummy, get_day_mapping, \
    ...
    get_consumption_time_mapping_4_ways, get_sun_hours, get_holiday_dummy_advanced


def model4_holidays_2(energyconsumption, offset_horizons=0):
...
def add_dummies(df):
    ...
    df = get_holiday_dummy_advanced(df)
    # df = get_sun_hours(df)
